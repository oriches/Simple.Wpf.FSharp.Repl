...
namespace Simple.Wpf.FSharp.Repl.Services
{
    public sealed class Process : IProcess
    {
        ...
        public Process(System.Diagnostics.Process process) => _process = process;
        ...
        public void WriteStandardInput(string line) => _process.StandardInput.WriteLine(line);

        public Task<int> StandardOutputReadAsync(CancellationToken cancellationToken) =>
            _process.StandardOutput.ReadAsync(cancellationToken);

        public Task<int> StandardErrorReadAsync(CancellationToken cancellationToken) =>
            _process.StandardError.ReadAsync(cancellationToken);
    }
}